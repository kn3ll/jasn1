...
public class GetBoundProfilePackageOk implements BerSequenceSet, Serializable {
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			...
			case "boundProfilePackage":
				return BoundProfilePackage.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "transactionId":
				...
				break;
			case "boundProfilePackage":
				boundProfilePackage = (BoundProfilePackage) value;
				break;
			default:
