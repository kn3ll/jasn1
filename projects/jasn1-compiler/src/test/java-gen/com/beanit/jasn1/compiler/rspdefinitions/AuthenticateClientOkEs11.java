...
public class AuthenticateClientOkEs11 implements BerSequenceSet, Serializable {

	private static final long serialVersionUID = 1L;

	public static class EventEntries implements BerSequenceOf, Serializable {
		...
		public EventEntries() {
			seqOf = new ArrayList<com.beanit.jasn1.compiler.rspdefinitions.EventEntries>();
		}
		...
		public EventEntries(List<com.beanit.jasn1.compiler.rspdefinitions.EventEntries> seqOf) {
			this.seqOf = seqOf;
		}
		...
		public Class<? extends BerType> getSeqOfElementClass() {
			return com.beanit.jasn1.compiler.rspdefinitions.EventEntries.class;
		}
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			if (length.val == -1) {
				while (true) {
					...
					com.beanit.jasn1.compiler.rspdefinitions.EventEntries element = new com.beanit.jasn1.compiler.rspdefinitions.EventEntries();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (seqOf == null) {
				...
				Iterator<com.beanit.jasn1.compiler.rspdefinitions.EventEntries> it = seqOf.iterator();
				if (it.hasNext()) {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "transactionId":
				...
				break;
			case "eventEntries":
				eventEntries = (EventEntries) value;
				break;
			default:
