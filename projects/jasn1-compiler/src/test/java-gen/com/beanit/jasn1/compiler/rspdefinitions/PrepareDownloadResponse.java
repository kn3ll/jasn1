...
public class PrepareDownloadResponse implements BerChoice, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "downloadResponseOk":
				return downloadResponseOk;
			case "downloadResponseError":
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "downloadResponseOk":
				return PrepareDownloadResponseOk.class;
			case "downloadResponseError":
				return PrepareDownloadResponseError.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "downloadResponseOk":
				downloadResponseOk = (PrepareDownloadResponseOk) value;
				break;
			case "downloadResponseError":
				downloadResponseError = (PrepareDownloadResponseError) value;
				break;
			default:
