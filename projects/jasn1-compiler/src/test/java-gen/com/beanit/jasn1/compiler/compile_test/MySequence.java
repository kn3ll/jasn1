...
public class MySequence implements BerSequenceSet, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "implVisibleString":
				return implVisibleString;
			default:
				return null;
		}
	}
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "implVisibleString":
				return ImplVisibleString.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "implVisibleString":
				implVisibleString = (ImplVisibleString) value;
				break;
			default:
