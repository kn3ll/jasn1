...
public class SetNicknameResponse implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "setNicknameResult":
				setNicknameResult = (BerInteger) value;
				break;
			default:
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += setNicknameResult.encode(reverseOS, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (setNicknameResult != null) {
			...
			sb.append("setNicknameResult: <empty-required-field>");
		}
