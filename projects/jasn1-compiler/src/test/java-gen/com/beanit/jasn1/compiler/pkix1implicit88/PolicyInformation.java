...
public class PolicyInformation implements BerSequenceSet, Serializable {

	private static final long serialVersionUID = 1L;

	public static class PolicyQualifiers implements BerSequenceOf, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "policyIdentifier":
				policyIdentifier = (CertPolicyId) value;
				break;
			case "policyQualifiers":
				policyQualifiers = (PolicyQualifiers) value;
				break;
			default:
