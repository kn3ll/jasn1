...
public class PEPUKCodes implements BerSequenceSet, Serializable {

	private static final long serialVersionUID = 1L;

	public static class PukCodes implements BerSequenceOf, Serializable {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += pukHeader.encode(reverseOS, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (pukHeader != null) {
			sb.append("pukHeader: ");
			pukHeader.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("pukHeader: <empty-required-field>");
		}
		...
		if (pukCodes != null) {
			...
			sb.append("pukCodes: <empty-required-field>");
		}
