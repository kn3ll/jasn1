...
public class EuiccMemoryResetRequest implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "resetOptions":
				resetOptions = (BerBitString) value;
				break;
			default:
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += resetOptions.encode(reverseOS, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (resetOptions != null) {
			...
			sb.append("resetOptions: <empty-required-field>");
		}
