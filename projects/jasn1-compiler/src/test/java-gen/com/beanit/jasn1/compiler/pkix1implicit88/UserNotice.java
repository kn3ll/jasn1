...
public class UserNotice implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "noticeRef":
				noticeRef = (NoticeReference) value;
				break;
			case "explicitText":
				explicitText = (DisplayText) value;
				break;
			default:
