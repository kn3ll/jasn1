...
public class CancelSessionRequestEs9 implements BerSequenceSet, Serializable {
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			...
			case "cancelSessionResponse":
				return CancelSessionResponse.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "transactionId":
				...
				break;
			case "cancelSessionResponse":
				cancelSessionResponse = (CancelSessionResponse) value;
				break;
			default:
