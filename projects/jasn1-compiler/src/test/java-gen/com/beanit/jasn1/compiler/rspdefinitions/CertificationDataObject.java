...
public class CertificationDataObject implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "platformLabel":
				platformLabel = (BerUTF8String) value;
				break;
			case "discoveryBaseURL":
				discoveryBaseURL = (BerUTF8String) value;
				break;
			default:
