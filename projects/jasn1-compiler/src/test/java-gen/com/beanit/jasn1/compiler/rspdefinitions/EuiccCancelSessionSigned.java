...
public class EuiccCancelSessionSigned implements BerSequenceSet, Serializable {
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			...
			case "reason":
				return CancelSessionReason.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			...
			case "smdpOid":
				...
				break;
			case "reason":
				reason = (CancelSessionReason) value;
				break;
			default:
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += smdpOid.encode(reverseOS, false);
