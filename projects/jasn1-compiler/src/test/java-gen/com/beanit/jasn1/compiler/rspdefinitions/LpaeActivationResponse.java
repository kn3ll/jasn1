...
public class LpaeActivationResponse implements BerSequenceSet, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "lpaeActivationResult":
				return lpaeActivationResult;
			default:
				return null;
		}
	}
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "lpaeActivationResult":
				lpaeActivationResult = (BerInteger) value;
				break;
			default:
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += lpaeActivationResult.encode(reverseOS, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (lpaeActivationResult != null) {
			...
			sb.append("lpaeActivationResult: <empty-required-field>");
		}
