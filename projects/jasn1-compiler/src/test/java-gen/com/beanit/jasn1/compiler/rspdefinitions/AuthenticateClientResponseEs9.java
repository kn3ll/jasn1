...
public class AuthenticateClientResponseEs9 implements BerChoice, Serializable {
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "authenticateClientOk":
				return AuthenticateClientOk.class;
			case "authenticateClientError":
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "authenticateClientOk":
				authenticateClientOk = (AuthenticateClientOk) value;
				break;
			case "authenticateClientError":
