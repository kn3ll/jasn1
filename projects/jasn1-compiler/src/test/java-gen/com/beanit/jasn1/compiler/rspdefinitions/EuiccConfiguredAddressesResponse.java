...
public class EuiccConfiguredAddressesResponse implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "defaultDpAddress":
				defaultDpAddress = (BerUTF8String) value;
				break;
			case "rootDsAddress":
				rootDsAddress = (BerUTF8String) value;
				break;
			default:
