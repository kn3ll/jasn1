...
public class GetBoundProfilePackageResponse implements BerChoice, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "getBoundProfilePackageOk":
				return getBoundProfilePackageOk;
			case "getBoundProfilePackageError":
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "getBoundProfilePackageOk":
				return GetBoundProfilePackageOk.class;
			case "getBoundProfilePackageError":
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "getBoundProfilePackageOk":
				getBoundProfilePackageOk = (GetBoundProfilePackageOk) value;
				break;
			case "getBoundProfilePackageError":
				getBoundProfilePackageError = (BerInteger) value;
				break;
			default:
