...
public class PresentationAddress implements BerSequenceSet, Serializable {

	private static final long serialVersionUID = 1L;

	public static class NAddresses implements BerSequenceOf, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "pSelector":
				pSelector = (BerOctetString) value;
				break;
			case "sSelector":
				sSelector = (BerOctetString) value;
				break;
			case "tSelector":
				tSelector = (BerOctetString) value;
				break;
			case "nAddresses":
				nAddresses = (NAddresses) value;
				break;
			default:
