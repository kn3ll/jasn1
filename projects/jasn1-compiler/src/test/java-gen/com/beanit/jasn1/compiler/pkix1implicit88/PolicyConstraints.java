...
public class PolicyConstraints implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "requireExplicitPolicy":
				requireExplicitPolicy = (SkipCerts) value;
				break;
			case "inhibitPolicyMapping":
				inhibitPolicyMapping = (SkipCerts) value;
				break;
			default:
