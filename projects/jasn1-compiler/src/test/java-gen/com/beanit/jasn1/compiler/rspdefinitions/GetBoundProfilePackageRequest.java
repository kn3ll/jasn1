...
public class GetBoundProfilePackageRequest implements BerSequenceSet, Serializable {
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			...
			case "prepareDownloadResponse":
				return PrepareDownloadResponse.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "transactionId":
				...
				break;
			case "prepareDownloadResponse":
				prepareDownloadResponse = (PrepareDownloadResponse) value;
				break;
			default:
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += prepareDownloadResponse.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 33)) {
				...
				subCodeLength += prepareDownloadResponse.decode(is, false);
				subCodeLength += berTag.decode(is);
			}
			int nextByte = is.read();
			if (berTag.tagNumber != 0 || berTag.tagClass != 0 || berTag.primitive != 0
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (prepareDownloadResponse != null) {
			...
			prepareDownloadResponse.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("prepareDownloadResponse: <empty-required-field>");
		}
