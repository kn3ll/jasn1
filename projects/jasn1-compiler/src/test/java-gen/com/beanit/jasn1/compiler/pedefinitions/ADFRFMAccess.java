...
public class ADFRFMAccess implements BerSequenceSet, Serializable {
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "adfAID":
				adfAID = (ApplicationIdentifier) value;
				break;
			case "adfAccessDomain":
				adfAccessDomain = (BerOctetString) value;
				break;
			case "adfAdminAccessDomain":
				adfAdminAccessDomain = (BerOctetString) value;
				break;
			default:
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += adfAdminAccessDomain.encode(reverseOS, false);
		// write tag: CONTEXT_CLASS, PRIMITIVE, 2
		reverseOS.write(0x82);
		codeLength += 1;
		
		codeLength += adfAccessDomain.encode(reverseOS, false);
		// write tag: CONTEXT_CLASS, PRIMITIVE, 1
		reverseOS.write(0x81);
		codeLength += 1;
		
		codeLength += adfAID.encode(reverseOS, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (adfAID != null) {
			...
			sb.append("adfAID: <empty-required-field>");
		}
		...
		if (adfAccessDomain != null) {
			...
			sb.append("adfAccessDomain: <empty-required-field>");
		}
		...
		if (adfAdminAccessDomain != null) {
			...
			sb.append("adfAdminAccessDomain: <empty-required-field>");
		}
