...
public class AuthenticateClientResponseEs11 implements BerChoice, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "authenticateClientOk":
				return authenticateClientOk;
			case "authenticateClientError":
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "authenticateClientOk":
				return AuthenticateClientOkEs11.class;
			case "authenticateClientError":
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "authenticateClientOk":
				authenticateClientOk = (AuthenticateClientOkEs11) value;
				break;
			case "authenticateClientError":
				authenticateClientError = (BerInteger) value;
				break;
			default:
