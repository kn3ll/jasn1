...
public class InitiateAuthenticationResponse implements BerChoice, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "initiateAuthenticationOk":
				return initiateAuthenticationOk;
			case "initiateAuthenticationError":
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "initiateAuthenticationOk":
				return InitiateAuthenticationOkEs9.class;
			case "initiateAuthenticationError":
	...
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "initiateAuthenticationOk":
				initiateAuthenticationOk = (InitiateAuthenticationOkEs9) value;
				break;
			case "initiateAuthenticationError":
				initiateAuthenticationError = (BerInteger) value;
				break;
			default:
