...
public class ProfileInstallationResult implements BerSequenceSet, Serializable {
	...
	public BerType getField(String fieldName) {
		switch(fieldName) {
			case "profileInstallationResultData":
	...
	public Class<? extends BerType> getFieldClass(String fieldName) {
		switch(fieldName) {
			case "profileInstallationResultData":
				return ProfileInstallationResultData.class;
			case "euiccSignPIR":
				return EuiccSignPIR.class;
			default:
				return null;
		}
	}
	public void setField(String fieldName, BerType value) {
		switch(fieldName) {
			case "profileInstallationResultData":
				profileInstallationResultData = (ProfileInstallationResultData) value;
				break;
			case "euiccSignPIR":
				euiccSignPIR = (EuiccSignPIR) value;
				break;
			default:
